	...
	<div id="g_web" class="g_web">
		...
		<div class='loginHeader webHeaderBg'>
			<a
				...
				class='g_close icon-gClose'></a><span class='title pageTitle'>修改运营商用户
		</div>
					...
					<div class='formMiddle formMiddle9'>
											...
											<form id="updateOperatorForm" name="updateOperatorForm"
												...
												<div class='g_globalLine '>
													<input type='text'
														...
														placeholder='请输入运营商用户密码(必填)' value="${ob.password}"><span
												...
												<div class='g_globalLine '>
													<input type='text'
														...
														name='operatorUuid' maxlength='50' placeholder='请输入运营商UUID(必填)' value="${ob.uuid}"><span
												...
												<div class='g_globalLine '>
													<input type='text'
														...
														name='operatorMajor' maxlength='50' placeholder='请输入运营商major(必填)' value="${ob.major}"><span
												...
												<div class='g_globalLine '>
													<input type='text'
														...
														placeholder='请输入运营商用户电话(必填)' value="${ob.phone}"><span
												...
												<div class='g_globalLine '>
													<input type='text' maxlength='50' id='operatorAddress'
														...
														class='mustItem itemEdit userAddItem g_input'
														placeholder='请输入运营商用户地址(必填)' value="${ob.address}"><span
						...
						<div class='signupSubmitCtrl g_globalLine'>
							<input type='button' style="cursor:pointer"
								...
								value='确认修改' onclick="updateOperator();" />
						</div>
