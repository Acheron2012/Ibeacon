	...
	<div id="g_web" class="g_web">
		...
		<div class='loginHeader webHeaderBg'>
			<a
				...
				class='g_close icon-gClose'></a><span class='title pageTitle'>修改设备信息
							...
							<div class='formMiddleContent formMiddleContent9 moduleContent'
								...
								<div id='signupPage'>
									...
									<div class='signUpContent'>
										<div id='profileArea'>
											<form id="updateDeviceForm" name="updateDeviceForm"
												action="updateDevice.do" method="post"
												enctype="multipart/form-data">
												<div class='g_globalLine '>
													<input type='text' maxlength='50' name='deviceName'
														id='deviceName'
														class='mustItem itemEdit userAddItem g_input'
														placeholder='请输入设备名称(必填)' value="${db.deviceName}"><span
												...
												<div class='g_globalLine '>
													<input type='text'
														...
														name='uuid' maxlength='50' readonly="readonly"
														value="${db.uuid}"><span
												...
												<div class='g_globalLine '>
													<input type='text'
														...
														name='major' maxlength='50' readonly="readonly"
														value="${db.major}"><span
														class='icon-majorIcon g_mainColor'></span><span
														class='mustIcon'>&nbsp;</span>
												</div>
												<div class='g_globalLine '>
													<input type='text' maxlength='50' id='minor' name='minor'
														class='mustItem itemEdit userAddItem g_input'
												...
												<div class='g_globalLine '>
													<input type='text' maxlength='50' id='deviceInfo'
														name='deviceInfo'
														class='mustItem itemEdit userAddItem g_input'
														placeholder='请输入设备信息' value="${db.deviceInfo}"><span
												...
												<div class='g_globalLine '>
													<input type='text' maxlength='50' id='title' name='title'
														class='mustItem itemEdit userAddItem g_input'
														placeholder='请输入展示标题' value="${db.title}"><span
												...
												<input type='hidden' id="deviceId" name='deviceId'
													...
													value='${db.imageUrl}'>
													<input type='hidden' id="oldVideoUrl" name='oldVideoUrl'
													value='${db.videoUrl}'>
										</div>
									</div>
								</div>
					...
					<div style="cursor:move;" _bannerautoheight="1"
						...
						<div class="titleCenter titleCenter414">
							<div class="titleText titleText414">
								...
								<div class="textContent">更换图片</div>
							</div>
					...
					<div style="cursor:move;" _bannerautoheight="1"
						...
						<div class="titleCenter titleCenter415">
							<div class="titleText titleText415">
								<div class="titleTextIcon icon-titleText">&nbsp;</div>
								<div class="textContent">更换视频</div>
							</div>
					...
					<div class="formMiddle formMiddle415">
						...
						<div class='signupSubmitCtrl g_globalLine'>
							<input type='button' style="cursor:pointer"
								...
								value='确认修改' onclick="updateDevice();" />
						</div>
