	...
	<div id="g_web" class="g_web">
		...
		<div class='loginHeader webHeaderBg'>
			<a
				...
				class='g_close icon-gClose'></a><span class='title pageTitle'>修改终端用户
					...
					<div class='formMiddle formMiddle9'>
											...
											<form id="updateClientForm" name="updateClientForm"
												...
												<div class='g_globalLine '>
													<input type='text'
														...
														placeholder='请输入终端用户密码(必填)' value="${cb.password}"><span
												...
												<div class='g_globalLine '>
													<input type='text'
														...
														placeholder='请输入终端用户电话(必填)' value="${cb.phone}"><span
												...
												<div class='g_globalLine '>
													<input type='text' maxlength='50' id='clientEmail'
														name='clientEmail'
														class='mustItem itemEdit userAddItem g_input'
														placeholder='请输入终端用户邮箱(必填)' value="${cb.email}"><span
												...
												<input type='hidden' id="operatorId" name='operatorId'
													value='${cb.operatorId}'> 
												<input type='hidden'
													id="clientId" name='clientId' value='${cb.id}'> 
												<input
						...
						<div class='signupSubmitCtrl g_globalLine'>
							<input type='button' style="cursor:pointer"
								...
								value='确认修改' onclick="updateClient();" />
						</div>
