...
<script type="text/javascript">
var operatorAddressBackUp=document.getElementById("operatorAddress").value
function openMap(){
...
<script type="text/javascript">
function alertV(){ 
	document.getElementById('operatorAddress').value = operatorAddressBackUp;
	 } 
setTimeout(alertV,10); 
</script>
</body>
</html>
